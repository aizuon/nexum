...
{
    [NetRmi(NexumOpCode.P2PGroup_MemberJoin)]
    internal partial class P2PGroup_MemberJoin
    {
        [NetProperty(0)]
        ...
        [NetProperty(4)]
        public ByteArray SessionKey { get; set; }

        [NetProperty(5)]
        public ByteArray FastSessionKey { get; set; }
